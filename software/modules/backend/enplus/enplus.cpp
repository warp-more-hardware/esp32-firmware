    ...
    PrivCommSend(0xAA, 6, PrivCommTxBuffer);
            ...
            case 0x03:
                ...
                switch (PrivCommRxBuffer[9]) {
                  case 1: logger.printfln("            Available (not engaged)"); break;
                  case 2: logger.printfln("            Preparing (engaged, not started"); break;
                  case 3: logger.printfln("            Charging (charging ongoing, power output"); break;
                  case 4: logger.printfln("            Suspended by charger (started but no power available)"); break;
                  case 5: logger.printfln("            Suspended by EV (power available but waiting for the EV response"); break;
                  case 6: logger.printfln("            Finishing, charging acomplished (RFID stop or EMS control stop"); break;
